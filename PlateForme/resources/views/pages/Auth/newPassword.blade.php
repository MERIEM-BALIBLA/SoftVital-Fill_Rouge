...
<body class="antialiased bg-slate-200">
    <div class="max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow shadow-slate-300">
        ...
        <form action="{{route('Reset.password.post')}}" method="POST" class="my-10">
            @csrf
            <div class="flex flex-col space-y-5">
                ...
                <label>
                    ...
                    <input name="password" type="password" class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Enter email address">
                </label>
                
                <label>
                    <p class="font-medium text-slate-700 pb-2">Confirm password</p>
                    <input name="password_confirmation" type="password" class="w-full py-3 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Enter email address">
                </label>
